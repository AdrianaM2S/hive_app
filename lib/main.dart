...
void main() async {
  ...
  Hive.registerAdapter(AccountAdapter()); // Register the Account adapter
  await Hive.openBox<Account>('accounts'); // Open the 'accounts' box
  ...
  void _addOrUpdateAccount() {
    ...
    if (_editingIndex == null) {
      ...
      final account = Account(
        ...
        createdAt: fechaActual, // Fecha de creación
        updateHistory: fechaActual, // Fecha de actualización inicial
      );
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(account.serviceType),
                          Text(
                              'Última actualización: ${account.updateHistory.toLocal()}'),
                        ],
                      ),
                      trailing: Row(
